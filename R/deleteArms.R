...
deleteArms <- function(url = getOption("redcap_bundle")$redcap_url,
...
deleteArms.redcapDbConnection <- function(url = getOption("redcap_bundle")$redcap_url,
token = getOption("redcap_token"),
 arms, ...){
...
deleteArms.redcapApiConnection <- function(url = getOption("redcap_bundle")$redcap_url,
token = getOption("redcap_token"),
 arms, ...,
