...
deleteRecords <- function(url = getOption("redcap_bundle")$redcap_url,
...
deleteRecords.redcapDbConnection <- function(url = getOption("redcap_bundle")$redcap_url,
token = getOption("redcap_token"),
 records, arms = NULL, ...){
...
deleteRecords.redcapApiConnection <- function(url = getOption("redcap_bundle")$redcap_url,
token = getOption("redcap_token"),
 records, arms = NULL, ...,
