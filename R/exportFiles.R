...
exportFiles <- function(url = getOption("redcap_bundle")$redcap_url,
token = getOption("redcap_token"),
 record, field, event = NULL, 
                              dir, 
                              filePrefix=TRUE, ...,
  ...
  else if (data_dict$field_type[data_dict$field_name == field] != "file")
  {
